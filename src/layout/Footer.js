...
function Footer() {
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 mx-auto w-full">
      <img alt='footer' src="https://www.floatui.com/logo.svg" className="w-32 sm:mx-auto mb-5" />
      ...
      <div className="mt-8 items-center justify-between sm:flex">
        ...
        <div className="mt-6 sm:mt-0">
          <ul className="flex items-center space-x-4">
            ...
            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
              <a rel="noreferrer" target={'_blank'} href="https://github.com/Dvir-Cohen1/deals-scanner">
                <GitHubIcon />
              </a>
            </li>
          </ul>
