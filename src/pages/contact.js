...
const contact = () => {
  return (
    <PageContainer textCenter={false}>
      <section class="min-h-screen lg:flex">
        <div class="flex flex-col justify-center w-full p-8  lg:px-12 xl:px-32 lg:w-1/2">
          <h1 class="text-3xl font-semibold capitalize dark:text-slate-800 lg:text-4xl">
            hire us.
          </h1>
          ...
          <div class="mt-6 md:mt-8">
            <h3 class="font-medium text-gray-600 dark:text-gray-500 ">
              Follow us
            </h3>
            ...
            <div class="-mx-2 md:items-center md:flex">
              <div class="flex-1 px-2">
                ...
                <input
                  ...
                  class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600  dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                />
              </div>
