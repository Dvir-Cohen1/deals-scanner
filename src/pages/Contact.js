...
import {HorizontalLine} from "../components/index";
import {styles} from '../assets/css/style'

const Contact = () => {
  return (
    <section className={"min-h-screen " + styles.defaultBackground}>
      <div className="container flex flex-col min-h-screen px-6 py-12 mx-auto">
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className={"text-white lg:w-1/2 lg:mx-6 " + styles.defaultTextColor}>
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2">
                <svg
                  ...
                  className={"w-6 h-6 mx-2 " + styles.defaultTextColor}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
                ...
                <span className={"mx-2 truncate w-72 " + styles.defaultTextColor}>
              ...
              <p className="flex items-start -mx-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={"w-6 h-6 mx-2 text-white " + styles.defaultTextColor}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
